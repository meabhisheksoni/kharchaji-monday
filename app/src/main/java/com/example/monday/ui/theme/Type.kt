...
// Define the Inter font family using the 18pt variant names
...
val Typography = Typography(
    ...
    titleMedium = TextStyle(
        fontFamily = InterFontFamily,
        fontWeight = FontWeight.Bold, // Or FontWeight.SemiBold based on preference
        fontSize = 16.sp,
        lineHeight = 24.sp,
    ...
    bodyMedium = TextStyle(
        fontFamily = InterFontFamily,
        fontWeight = FontWeight.Normal, // Or FontWeight.Medium for slightly more emphasis
        fontSize = 14.sp,
        lineHeight = 20.sp,
    ...
    labelLarge = TextStyle(
        fontFamily = InterFontFamily,
        fontWeight = FontWeight.Medium, // Or FontWeight.SemiBold
        fontSize = 14.sp,
        lineHeight = 20.sp,
        letterSpacing = 0.1.sp
    ),
